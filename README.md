...
<h3 align="center">Information Systems Student | Data & ML Enthusiast | Photographer</h3>
...
- 🎓 Information Systems student, currently building strong foundations in **Python**, **Data Science**, and **Machine Learning**.
- 🎯 Working toward a tech role where I can use data to support strategic, evidence-based decisions.
- 🇨🇳 Learning **Mandarin** alongside my technical coursework, with an eye toward future international graduate study.
- 🛠️ Background in software engineering (**Flutter**) and user-centered platform design.
- 📈 I treat this transition like any system I build — define clear metrics, iterate quickly, and improve continuously.
